...
: ${AMENT_CURRENT_PREFIX:="/home/kaban/project_robot_ws_sim/project_robot_ws/sim/install/robot_sim"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_sim/environment/sim.sh"
